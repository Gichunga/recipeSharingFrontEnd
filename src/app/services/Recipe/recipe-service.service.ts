      ...
      .pipe(
        tap((newRecipe) => {
          ...
          this.recipeSubject.next({
            //add the recipe array to current state
            ...currentState,
            recipes: [newRecipe, ...currentState], // update the recipes array and add the created recipe
          });
        })
      );
  }
    ...
    return this.http
      ...
      .pipe(
        tap((updatedRecipe: any) => {
          ...
          this.recipeSubject.next({
            ...currentState,
            recipes: updatedRecipes, // update the recipes array and add the created recipe
          });
        })
      );
  }
